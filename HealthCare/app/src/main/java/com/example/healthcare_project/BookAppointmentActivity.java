        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(db.checkAppointmentExists(username, title+" => "+fullname, address, contact, dateButton.getText().toString(), timeButton.getText().toString() )==1){
                    Toast.makeText(getApplicationContext(), "Doctor Appointment is already scheduled in this slot", Toast.LENGTH_LONG).show();
                }
                else{
                    ...
                    Toast.makeText(getApplicationContext(), "Your Appointment booking is successful", Toast.LENGTH_LONG).show();
